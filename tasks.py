...
def docker_compose(context, command, **kwargs):
    ...
    compose_command = f'docker-compose --project-name {context.nautobot_device_lifecycle_mgmt.project_name} --project-directory "{context.nautobot_firewall_models.compose_dir}"'
