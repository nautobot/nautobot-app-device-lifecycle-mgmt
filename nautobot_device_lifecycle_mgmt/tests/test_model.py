...
class MigrationTestCase(TestCase):
    def test_contactlcm_fields(self):
        ...
        self.assertTrue(contact._meta.get_field("address").blank)
        self.assertEqual(contact._meta.get_field("name").max_length, 255)
        self.assertTrue(contact._meta.get_field("name").null)
        self.assertEqual(contact._meta.get_field("phone").max_length, 255)
        self.assertTrue(contact._meta.get_field("phone").blank)
        self.assertEqual(contact._meta.get_field("type").max_length, 255)
        self.assertEqual(contact._meta.get_field("type").default, "Unassigned")

    def test_contractlcm_fields(self):
        contract = ContractLCM.objects.create(contract_type="", name="UniqueName", number="", support_level="")
        self.assertEqual(contract._meta.get_field("contract_type").max_length, 255)
        self.assertTrue(contract._meta.get_field("contract_type").blank)
        self.assertEqual(contract._meta.get_field("contract_type").default, "")
        self.assertEqual(contract._meta.get_field("name").max_length, 255)
        self.assertTrue(contract._meta.get_field("name").unique)
        self.assertEqual(contract._meta.get_field("number").max_length, 255)
        self.assertTrue(contract._meta.get_field("number").blank)
        self.assertEqual(contract._meta.get_field("number").default, "")
        self.assertEqual(contract._meta.get_field("support_level").max_length, 255)
        self.assertTrue(contract._meta.get_field("support_level").blank)
        self.assertEqual(contract._meta.get_field("support_level").default, "")

    def test_cvelcm_fields(self):
        cve = CVELCM.objects.create(name="UniqueName", severity="None")
        self.assertEqual(cve._meta.get_field("name").max_length, 255)
        self.assertTrue(cve._meta.get_field("name").unique)
        self.assertEqual(cve._meta.get_field("severity").max_length, 255)
        self.assertEqual(cve._meta.get_field("severity").default, "None")

    def test_devicesoftwarevalidationresult_fields(self):
        device_software_validation = DeviceSoftwareValidationResult.objects.create(run_type="RunType")
        self.assertEqual(device_software_validation._meta.get_field("run_type").max_length, 255)

    def test_inventoryitemsoftwarevalidationresult_fields(self):
        inventory_item_validation = InventoryItemSoftwareValidationResult.objects.create(run_type="RunType")
        self.assertEqual(inventory_item_validation._meta.get_field("run_type").max_length, 255)

    def test_providerlcm_fields(self):
        provider = ProviderLCM.objects.create(name="UniqueName", description="", phone="", physical_address="")
        self.assertEqual(provider._meta.get_field("description").max_length, 255)
        self.assertTrue(provider._meta.get_field("description").blank)
        self.assertEqual(provider._meta.get_field("name").max_length, 255)
        self.assertTrue(provider._meta.get_field("name").unique)
        self.assertEqual(provider._meta.get_field("phone").max_length, 255)
        self.assertTrue(provider._meta.get_field("phone").blank)
        self.assertEqual(provider._meta.get_field("physical_address").max_length, 255)
        self.assertTrue(provider._meta.get_field("physical_address").blank)

    def test_softwareimagelcm_fields(self):
        software_image = SoftwareImageLCM.objects.create(hashing_algorithm="", image_file_name="ImageName")
        self.assertEqual(software_image._meta.get_field("hashing_algorithm").max_length, 255)
        self.assertTrue(software_image._meta.get_field("hashing_algorithm").blank)
        self.assertEqual(software_image._meta.get_field("hashing_algorithm").default, "")
        self.assertEqual(software_image._meta.get_field("image_file_name").max_length, 255)

    def test_softwarelcm_fields(self):
        software = SoftwareLCM.objects.create(alias="", version="Version")
        self.assertEqual(software._meta.get_field("alias").max_length, 255)
        self.assertTrue(software._meta.get_field("alias").blank)
        self.assertEqual(software._meta.get_field("alias").default, "")
        self.assertEqual(software._meta.get_field("version").max_length, 255)
