...
class DeviceSoftwareImageFilterTestCase(
        TestCase):  # pylint: disable=too-many-instance-attributes
    ...
    def setUp(self):
        ...
        devicerole = DeviceRole.objects.create(
            name="Switch", slug="switch", color="ff0000")
    ...
    def test_soft_image_for_device_match_tag(self):
        ...
        soft_image_filtered_qs = DeviceSoftwareImageFilter(
            software_image_qs, self.device_1).filter_qs()
    ...
    def test_soft_image_for_device_match_device_type(self):
        software_image_qs = SoftwareImageLCM.objects.all()
        soft_image_filtered_qs = DeviceSoftwareImageFilter(
            software_image_qs, self.device_2).filter_qs()
    ...
    def test_soft_image_for_device_match_default(self):
        software_image_qs = SoftwareImageLCM.objects.all()
        soft_image_filtered_qs = DeviceSoftwareImageFilter(
            software_image_qs, self.device_3).filter_qs()
    ...
    def test_soft_image_for_device_tag_wins_over_device_type(self):
        software_image_qs = SoftwareImageLCM.objects.all()
        soft_image_filtered_qs = DeviceSoftwareImageFilter(
            software_image_qs, self.device_4).filter_qs()

        self.assertEqual(soft_image_filtered_qs.count(), 1)
        self.assertEqual(soft_image_filtered_qs[0], self.soft_image_ot_win)


class InventoryItemSoftwareImageFilterTestCase(
        TestCase):  # pylint: disable=too-many-instance-attributes
    ...
    def setUp(self):
        ...
        self.inventoryitem_2 = InventoryItem.objects.create(
        ...
        self.inventoryitem_3 = InventoryItem.objects.create(
            device=self.device_1, name="SwitchModule3")
        RelationshipAssociation.objects.create(
            source=self.software,
        ...
        self.inventoryitem_4 = InventoryItem.objects.create(
            device=self.device_1, name="SwitchModule4")
        ...
        self.soft_image_spec_assgmt_lose.inventory_items.set(
            [self.inventoryitem_4.pk])
        self.soft_image_spec_assgmt_lose.save()

    def test_soft_image_for_invitem_match_tag(self):
        software_image_qs = SoftwareImageLCM.objects.all()
        soft_image_filtered_qs = InventoryItemSoftwareImageFilter(
            software_image_qs, self.inventoryitem_1).filter_qs()
    ...
    def test_soft_image_for_invitem_match_invitem(self):
        software_image_qs = SoftwareImageLCM.objects.all()
        soft_image_filtered_qs = InventoryItemSoftwareImageFilter(
            software_image_qs, self.inventoryitem_2).filter_qs()
    ...
    def test_soft_image_for_invitem_match_default(self):
        software_image_qs = SoftwareImageLCM.objects.all()
        soft_image_filterd_qs = InventoryItemSoftwareImageFilter(
            software_image_qs, self.inventoryitem_3).filter_qs()

        self.assertEqual(soft_image_filterd_qs.count(), 1)
        self.assertEqual(soft_image_filterd_qs[0], self.soft_image_def)

    def test_soft_image_for_invitem_match_tag_wins_over_specific_assignment(
            self):
        software_image_qs = SoftwareImageLCM.objects.all()
        soft_image_filterd_qs = InventoryItemSoftwareImageFilter(
            software_image_qs, self.inventoryitem_4).filter_qs()
