...
class SoftwareNoticeTestCase(TestCase):
    """Tests for SoftwareNoticeFilterSet."""

    queryset = SoftwareNotice.objects.all()
    filterset = SoftwareNoticeFilterSet
    ...
    def setUp(self):
        ...
        self.software_versions = (
            SoftwareVersion.objects.get_or_create(
        ...
        self.notices = (
            SoftwareNotice.objects.create(
                software_version=self.software_versions[0],
                end_of_sale="2022-04-01",
                end_of_support="2023-04-01",
                end_of_sw_releases="2024-04-01",
                end_of_security_patches="2025-04-01",
            ...
            SoftwareNotice.objects.create(
                software_version=self.software_versions[0],
                device_type=self.device_types[0],
                end_of_sale="2030-04-01",
                end_of_support="2031-04-01",
                end_of_sw_releases="2032-04-01",
                end_of_security_patches="2033-04-01",
                documentation_url="https://cisco.com/c9300-24",
            ),
            SoftwareNotice.objects.create(
                software_version=self.software_versions[0],
            ...
            SoftwareNotice.objects.create(
                software_version=self.software_versions[1],
                device_type=self.device_types[0],
                end_of_sale="2028-01-01",
                end_of_support="2028-01-01",
                end_of_sw_releases="2028-01-01",
                end_of_security_patches="2028-01-01",
                documentation_url="https://cisco.com/c9300-24",
            ),
            SoftwareNotice.objects.create(
                software_version=self.software_versions[1],
    ...
    def test_software_version_version_single(self):
        """Test software_version filter."""
        params = {"software_version_version": ["15.1(2)M"]}
        self.assertEqual(self.filterset(params, self.queryset).qs.count(), 3)

    def test_software_version_version_many(self):
        """Test software_version filter."""
        params = {"software_version_version": ["15.1(2)M", "4.22.9M"]}
        self.assertEqual(self.filterset(params, self.queryset).qs.count(), 5)

    def test_software_version_id_single(self):
        """Test software_version_id filter."""
        params = {"software_version": [self.software_versions[0].id]}
        self.assertEqual(self.filterset(params, self.queryset).qs.count(), 3)

    def test_software_version_id_many(self):
        """Test software_version_id filter."""
        params = {"software_version": [self.software_versions[0].id, self.software_versions[1].id]}
        self.assertEqual(self.filterset(params, self.queryset).qs.count(), 5)
    ...
    def test_device_types_name_many(self):
        """Test device_type filter."""
        params = {"device_type_model": ["c9300-24", "c9300-48"]}
    ...
    def test_device_types_id_many(self):
        """Test device_type_id filter."""
        params = {"device_type": [self.device_types[0].id, self.device_types[1].id]}
        self.assertEqual(self.filterset(params, self.queryset).qs.count(), 4)
