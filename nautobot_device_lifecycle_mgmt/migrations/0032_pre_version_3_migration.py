    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory_items', models.ManyToManyField(blank=True, related_name='+', to='dcim.inventoryitem')),
                ...
                ('object_tags', models.ManyToManyField(blank=True, related_name='+', to='extras.tag')),
