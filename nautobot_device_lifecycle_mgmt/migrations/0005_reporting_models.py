# Generated by Django 3.1.13 on 2021-11-22 21:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("sw_missing", models.BooleanField(blank=True, null=True)),
                ("last_run", models.DateTimeField(blank=True, null=True)),
                (
                    "inventory_item",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="dcim.inventoryitem"),
                ),
                (
                    "software",
                    models.ForeignKey(
