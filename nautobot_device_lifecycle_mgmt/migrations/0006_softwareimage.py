# Generated by Django 3.2.10 on 2022-01-28 18:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_types', models.ManyToManyField(blank=True, related_name='_nautobot_device_lifecycle_mgmt_softwareimage_device_types_+', to='dcim.DeviceType')),
                ('inventory_items', models.ManyToManyField(blank=True, related_name='_nautobot_device_lifecycle_mgmt_softwareimage_inventory_items_+', to='dcim.InventoryItem')),
                ('object_tags', models.ManyToManyField(blank=True, related_name='_nautobot_device_lifecycle_mgmt_softwareimage_object_tags_+', to='extras.Tag')),
