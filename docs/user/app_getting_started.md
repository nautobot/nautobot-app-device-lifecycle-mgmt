...
2. Review [Nautobot and Device Lifecycle – Nautobot LCM Application – Part 3](https://networktocode.com/blog/nautobot-and-device-lifecycle-part-3/).<br>
...
3. Review [Nautobot Device Lifecycle Management App 3.0](https://networktocode.com/blog/2025-06-13-nautobot-device-lifecycle-mgmt/).<br>
   This article covers changes introduced in version 3.0 of Device Lifecycle Management, including migration steps for models that have moved to Core Nautobot.
